...
export default {
  ...
  'TEST': {
    ...
    s2r: 'The model achieved a mean squared error of 0.004 on the test set.',
    ...
    s2sm: 'The model achieved a mean absolute error of 31.7 on the test set.',
    ...
    s2s: 'The model achieved an accuracy of 84.0% on the test set.',
